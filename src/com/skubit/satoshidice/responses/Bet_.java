...
public class Bet_ {
    ...
    @JsonProperty("streakBetInSatoshis")
    private Integer streakBetInSatoshis;
    @JsonProperty("streakWinInSatoshis")
    private Integer streakWinInSatoshis;
    @JsonProperty("streakProbability")
    private Double streakProbability;
    @JsonProperty("roll")
    private Integer roll;
    @JsonProperty("rollInPercent")
    private Double rollInPercent;
    @JsonProperty("time")
    private String time;
    @JsonProperty("result")
    private String result;
    @JsonProperty("betInSatoshis")
    private String betInSatoshis;
    @JsonProperty("prize")
    private Integer prize;
    @JsonProperty("prizeInSatoshis")
    private String prizeInSatoshis;
     ...
     * 
     * @return
     *     The streakBetInSatoshis
     */
    @JsonProperty("streakBetInSatoshis")
    public Integer getStreakBetInSatoshis() {
        return streakBetInSatoshis;
    }

    /**
     * 
     * @param streakBetInSatoshis
     *     The streakBetInSatoshis
     */
    @JsonProperty("streakBetInSatoshis")
    public void setStreakBetInSatoshis(Integer streakBetInSatoshis) {
        this.streakBetInSatoshis = streakBetInSatoshis;
    }

    /**
     * 
     * @return
     *     The streakWinInSatoshis
     */
    @JsonProperty("streakWinInSatoshis")
    public Integer getStreakWinInSatoshis() {
        return streakWinInSatoshis;
    }

    /**
     * 
     * @param streakWinInSatoshis
     *     The streakWinInSatoshis
     */
    @JsonProperty("streakWinInSatoshis")
    public void setStreakWinInSatoshis(Integer streakWinInSatoshis) {
        this.streakWinInSatoshis = streakWinInSatoshis;
    }
     ...
     */
    @JsonProperty("rollInPercent")
    public Double getRollInPercent() {
     ...
     */
    @JsonProperty("rollInPercent")
    public void setRollInPercent(Double rollInPercent) {
     ...
     */
    @JsonProperty("betInSatoshis")
    public String getBetInSatoshis() {
     ...
     */
    @JsonProperty("betInSatoshis")
    public void setBetInSatoshis(String betInSatoshis) {
     ...
     */
    @JsonProperty("prizeInSatoshis")
    public String getPrizeInSatoshis() {
     ...
     */
    @JsonProperty("prizeInSatoshis")
    public void setPrizeInSatoshis(String prizeInSatoshis) {
